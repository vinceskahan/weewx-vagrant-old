...
known_weehosts = {
    ...
    "centos6pkg"   => { :ip => "192.168.33.25", :port => 8825, :mem => 512, :box => "centos/6",         :setup => "setup-centos.sh", :provisioner => "weewx-rh-rpm-initd.sh" },
    "centos7pkg"   => { :ip => "192.168.33.26", :port => 8826, :mem => 512, :box => "centos/7",         :setup => "setup-centos.sh", :provisioner => "weewx-rh-rpm-initd.sh" },
}
